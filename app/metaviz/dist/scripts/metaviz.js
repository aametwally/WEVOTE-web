...
(function (metaviz) {
    ...
    var DonutChartController = (function () {
        function DonutChartController($scope, $interval) {
            var _this = this;
            this.$scope = $scope;
            ...
            $interval(function () {
                _this._scope.data = d3.range(10).map(function (d) {
                    return Math.random();
                });
            }, 1000);
        }
        DonutChartController.$inject = ['$scope', '$interval', DonutChartController];
        return DonutChartController;
    }());
    metaviz.DonutChartController = DonutChartController;
    metaviz.metavizApp
