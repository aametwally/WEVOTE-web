...
## Usage
1. Launch an instance with approporiate specifications using the public AMI [ami-0f873d75](https://console.aws.amazon.com/ec2/v2/home?region=us-east-1#Images:visibility=public-images;search=ami-0212a978;sort=tag:Name).
